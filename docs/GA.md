...
**25 services, 625 operation/transport cells.** The canonical sources are
...
| gRPC (proto descriptors + official-client conformance) | 215 | 12 | 0 | 12 |
...
- **gRPC** — official `cloud.google.com/go` clients: **229/229 checks pass** (Dataproc 14,
  Datastore 11, Firestore 18, Functions 18, IAM 3, KMS 31, Logging 5, Managed Kafka 18,
  Monitoring 24, Operations 5, Pub/Sub 25, Resource Manager 4, Secret Manager 16, Service Usage 5,
  Storage 23, Workflow Executions 4, Workflows 5) against `:8081`.
...
- **gRPC** — **12** of **239** cells remain `limited`: verified against proto descriptors only.
  The other **215** are `ga` (plus **12** explicit `unsupported` stubs: Dataproc `DiagnoseCluster`,
  Functions `CallFunction`/`ListRuntimes`, Service Usage `BatchGetServices`, Workflows
  `ListWorkflowRevisions`, and Cloud Resource Manager's 7 project lifecycle/lookup RPCs),
  ...
  Managed Kafka 17, Operations 5, Pub/Sub 25, Resource Manager 4, Firestore 17, Monitoring 24,
  Workflow Executions 4, Workflows 5, Functions 10, Service Usage 5). The conformance
  harness exercises 229 checks over those 215 proto methods (Dataproc 14, Datastore 11, Firestore 18,
  Functions 18, IAM 3, KMS 31, Managed Kafka 18, Monitoring 24, Operations 5, Pub/Sub 25,
