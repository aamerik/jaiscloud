...
**26 services, 712 operation/transport cells.** The canonical sources are
...
| --- | ---: | ---: | ---: | ---: |
| REST (JSON, Discovery-backed) | 249 | 89 | 37 | 9 |
...
- **Dual-protocol parity.** Every GA service that real GCP serves over both REST and gRPC now
  ...
  **26 services / 712 operation/transport cells** — `ga` 494, `limited` 100, `preview` 37,
