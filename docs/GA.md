...
**25 services, 575 operation/transport cells.** The canonical sources are
...
| gRPC (proto descriptors + official-client conformance) | 177 | 12 | 0 | 0 |
...
- **gRPC** — official `cloud.google.com/go` clients: **183/183 checks pass** (Datastore 11,
  Firestore 18, IAM 3, KMS 31, Logging 5, Managed Kafka 18, Monitoring 24, Operations 5,
  Pub/Sub 25, Secret Manager 16, Storage 23, Workflow Executions 4) against `:8081`.
...
- **gRPC** — **12** of **189** cells remain `limited`: verified against proto descriptors only.
  The other **177** are `ga`, verified with the official `cloud.google.com/go` clients against a
  ...
  harness exercises 183 checks over those 177 proto methods (Datastore 11, Firestore 18, IAM 3,
  KMS 31, Managed Kafka 18, Monitoring 24, Operations 5, Storage 23, Secret Manager 16,
