...
// BootstrapSparkEnvCfg holds the credentials/endpoint needed by bootstrap init containers.
type BootstrapSparkEnvCfg struct {
	Region       string
	S3Endpoint   string
	AWSAccessKey string
	AWSSecretKey string
...
func bootstrapSparkEnv(cfg BootstrapSparkEnvCfg) []k8stypes.EnvVar {
